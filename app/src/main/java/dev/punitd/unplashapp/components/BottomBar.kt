...
enum class BottomBarDestination(
    ...
    Photos(PhotosListScreenRouteDestination, Icons.Default.Home, R.string.home_screen),
    Search(SearchPhotosScreenRouteDestination, Icons.Default.Search, R.string.search_screen)
}